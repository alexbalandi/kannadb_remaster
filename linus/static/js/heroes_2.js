$(document).ready(function () {
  ...
  $.fn.dataTable.ext.search.push(function (settings, data, dataIndex) {
    ...
    $(".stat-range-slider-widget").each(function (index) {
      ...
      var col_index =
        column_visibility[current_vis][parseFloat($(this).attr("data-index"))];
  ...
  var renderIcon = function (dataField, type) {
    if (type == "display") {
      ...
      return "<img " + tippy + ' height="30pt" src="' + dataField.icon + '">';
  ...
  var renderStat = function (dataField, type) {
    if (type == "display") {
      var res = "";
      if (dataField.bb == "+")
        res = '<span class="text-primary font-weight-bold">';
      if (dataField.bb == "-")
        res = '<span class="text-danger font-weight-bold">';
